...
<title>Administor Reset Password</title>
...
<table width="100%" height="625px" border="1">
  ...
  <tr height="475px">
    <td><form method="post" name="form1" action="AdminResetPasswordHandler.jsp" onSubmit="return validateForm();">
      <table width="50%"  height="200px" style="border:dashed" align="center">
        <tr><center>
        ...
        <tr >
          ...
          <td colspan="3" align="center">You can reset administor's password from here </td>
          </tr>
		  
		<tr>
		 <td><label>Id </label></td>
          <td colspan="2"><label>
            <input name="id" type="text" id="id" value="<%= admin.getId()%>" readonly="readonly">
          </label></td> 
		</tr>  
        <tr >
        ...
        <tr >
          ...
          <td><label>
            <input name="Cancel" type="button" id="Cancel" value="Cancel"  onClick="window.location.href='AdminList.jsp'" >
          </label></td>
        </tr>
      </table>
        </form>    </td>
