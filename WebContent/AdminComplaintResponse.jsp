...
{
  window.location.href="AdminComplaintResponse.jsp?status="+status;
}
...
<tr height="475px">
    <td style="color:#CC0000"><div style="overflow:auto; height:450px; "><table width="1200" align="center">
      <tr>
        <td colspan="10" class="style4"><center>
      ...
      <tr>
        <td height="30" class="style5">Status</td>
		<td height="30" class="style2"><select name="status" id="status" onChange="getValueByStatus(this.value)">
	  ...
	  ArrayList list = complaint.getAdminComplaintList();
      ...
      <tr bgcolor=<%=i%2==0?"#FFFBF0":"#CCCCFF"%>>
		...
		<td style="width:300px;"><a href="AdminViewComplaint.jsp?complaintId=<%=complaintIdList.get(i)%>">View</a>
		</td>
      </tr>
	  <%}
	  }else{
