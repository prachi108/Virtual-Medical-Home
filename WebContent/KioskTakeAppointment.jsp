...
<table width="100%" height="625px" border="1">
  ...
  <tr height="475px">
    <td align="center"><form method="post" name="form1" action="KioskTakeAppointmentHandler.jsp" onSubmit="return validateForm();">
	  <table width="70%">
        ...
        <tr>
          <td height="28" class="style5">Patient Name* </td>
          <td class="style2"><label>
           <select name="patientName" id="patientName">
	<%
	  ArrayList list1=appointment.getPatientList();
	  ...
	  %>
	   ...
	   <%}
        ...
        <tr>
          <td width="18%" height="28" class="style5">Doctor Name* </td>
          <td width="27%" class="style2"><label>
            <select name="doctorName" id="doctorName">
	<%
	    list1=appointment.getDoctorList();
	  if(list1!=null && list1.size()>0){
		for(int i=0;i<list1.size();i++){
	  ...
	  %>
	   ...
	   <%}
        ...
        <tr>
          <td height="29" class="style5">Description*</td>
          <td rowspan="2" class="style2"><label>
          ...
          <td width="26%" class="style5">Appointment Request Date* </td>
          <td width="29%" class="style2"><label>
        ...
        <tr>
		  ...
		  <%  if(list1 == null || list2 == null){   %>
            <input name="Get Appointment" type="submit" id="Get Appointment" style="width:150px;" value="Get Appointment" disabled="disabled">
		  <%  }else{   %>
		  <input name="Get Appointment" type="submit" id="Get Appointment" style="width:150px;" value="Get Appointment">
		  <%  }  %>	
          </label></td>
          </tr>
      </table>
