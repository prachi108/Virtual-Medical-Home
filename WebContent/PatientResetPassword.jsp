...
<table width="100%" height="600px" border="1">
  ...
  <tr height="500px">
    <td><form method="post" name="form1" action="PatientResetPasswordHandler.jsp" onSubmit="return validateForm();">
      <table width="50%"  height="200px" align="center" style="border:dashed">
        ...
        <tr >
          ...
          <td colspan="3" align="center">You can reset patient's password from here </td>
          </tr>
		  
		<tr>
		 <td><label>Id </label></td>
          <td colspan="2"><label>
            <input name="id" type="text" id="id" value="<%= patient.getId()%>" readonly="readonly">
          </label></td> 
		</tr>  
        <tr >
        ...
        <tr >
          ...
          <td><label>
            <input name="Cancel" type="button" id="Cancel" value="Cancel"  onClick="window.location.href='PatientList.jsp'" >
          </label></td>
        </tr>
      </table>
        </form>    </td>
