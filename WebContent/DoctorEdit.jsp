<%@ page contentType="text/html; charset=iso-8859-1" language="java" import="java.sql.*,java.util.*" errorPage="ErrorPage.jsp" %>
...
function validateForm()
 { 
	...
	if(document.form1.experience.value == "null")
	 {
...
<tr height="475px">
    <td><center>
      <form name="form1" method="post" onSubmit="return validateForm();" action="DoctorEditHandler.jsp">
        <table width="80%">
          <tr>
            <td colspan="5"><div align="center">
              <h2><strong><span style="color: #0000ff">DOCTOR REGISTRATION FORM </span></strong></h2>
            </div></td>
          </tr>
          ...
          <tr>
            ...
            <td width="20%" class="style2"><label>
              <input name="name" type="text" id="name" value="<%= doctor.getName()%>" maxlength="50">
            </label></td>
            <td width="17%" class="style6">Fathers Name* </td>
            <td width="26%"><label>
              <input name="fname" type="text" id="fname" value="<%= doctor.getFname()%>" maxlength="50">
            </label></td>
            <td width="20%">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <input name="dob" type="text" id="dob" value="<%= doctor.getDob()%>">
            </label></td>
          ...
          <tr>
            ...
            <td class="style2"><label>
              ...
              Other</label>
               <script>
			  if('<%=doctor.getNationality()%>'=='Indian'){
            ...
            <td><label>
              <select name="qualification" id="qualification">
                ...
                <script>document.getElementById('qualification').value='<%=doctor.getQualification()%>';</script>
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <select name="experience" id="experience">
                ...
                <option value="2-5 Years">1-5 Years</option>
                <option value="5-10 Years">5-10 Years</option>
                <option value="More than 5 Years">More than 5 Years</option>
              </select>
              <script>document.getElementById('experience').value='<%=doctor.getExperience()%>';</script>
            </label></td>
          ...
          <tr>
            ...
            <td class="style2"><label>
              <input name="address1" type="text" id="address1" onKeyUp="writeOn('address1');" value="<%= doctor.getAddress1()%>" maxlength="300">
            </label></td>
            <td class="style6">Address</td>
            <td><label>
              <input name="address2" type="text" id="address2" value="<%= doctor.getAddress2()%>" maxlength="300">
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <input name="city1" type="text" id="city1" onKeyUp="writeOn('city1');" value="<%= doctor.getCity1()%>" maxlength="30">
            </label></td>
            <td class="style6">City</td>
            <td><label>
              <input name="city2" type="text" id="city2" value="<%= doctor.getCity2()%>" maxlength="30">
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <input name="state1" type="text" id="state1" onKeyUp="writeOn('state1')" value="<%= doctor.getState1()%>" maxlength="30">
            </label></td>
            <td class="style6">State</td>
            <td><label>
              <input name="state2" type="text" id="state2" value="<%= doctor.getState2()%>" maxlength="30">
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <input name="country1" type="text" id="country1" onKeyUp="writeOn('country1')" value="<%= doctor.getCountry1()%>" maxlength="30">
            </label></td>
            <td class="style6">Country</td>
            <td><label>
              <input name="country2" type="text" id="country2" value="<%= doctor.getCountry2()%>" maxlength="30">
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
            <input name="zip1" type="text" id="zip1" onKeyUp="writeOn('zip1')" value="<%= doctor.getZip1()%>" maxlength="6" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td class="style6">Zip</td>
            <td><label>
              <input name="zip2" type="text" id="zip2" value="<%= doctor.getZip2()%>" maxlength="6" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <input name="landline1" type="text" id="landline1" onKeyUp="writeOn('landline1')" value="<%= doctor.getLandline1()%>" maxlength="20" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td class="style6">Phone </td>
            <td><label>
              <input name="landline2" type="text" id="landline2" value="<%= doctor.getLandline2()%>" maxlength="20" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style8"><label>
              <input name="mobile1" type="text" id="mobile1" onKeyUp="writeOn('mobile1')" value="<%= doctor.getMobile1()%>" maxlength="15" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td class="style9">Mobile</td>
            <td class="style10"><label>
              <input name="mobile2" type="text" id="mobile2" value="<%= doctor.getMobile2()%>" maxlength="15" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="style2"><label>
              <input name="email" type="text" id="email" value="<%= doctor.getEmail()%>" maxlength="30">
            </label></td>
            <td class="style6">Alternate Email </td>
            <td><label>
              <input name="alternateEmail" type="text" id="alternateEmail" value="<%= doctor.getAlternateEmail()%>" maxlength="30">
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <select name="bloodGroup" id="bloodGroup">
                ...
                <script>document.getElementById('bloodGroup').value='<%=doctor.getBloodGroup()%>';</script>
            </label></td>
            <td colspan="3">&nbsp;</td>
            </tr>
          <tr>
