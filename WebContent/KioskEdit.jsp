...
<title>Kiosk Registration Form</title>
...
<tr height="475px">
    <td><center>
      <form name="form1" method="post" onSubmit="return validateForm();" action="KioskEditHandler.jsp">
        <table width="80%">
          <tr>
            <td colspan="5"><div align="center">
              <h2><strong><span style="color: #0000ff">KIOSK REGISTRATION FORM </span></strong></h2>
            </div></td>
          </tr>
          ...
          <tr>
            ...
            <td width="20%" class="style2"><label>
              <input name="name" type="text" id="name" value="<%= kiosk.getName()%>" maxlength="50">
            </label></td>
            <td width="17%" class="style6">Fathers Name* </td>
            <td width="26%"><label>
              <input name="fname" type="text" id="fname" value="<%= kiosk.getFname()%>" maxlength="50">
            </label></td>
            <td width="20%">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <input name="dob" type="text" id="dob" value="<%= kiosk.getDob()%>">
            </label></td>
          ...
          <tr>
            ...
            <td class="style2"><label>
              ...
              Other</label>
			  <script>
			  if('<%=kiosk.getNationality()%>'=='Indian'){
            ...
            <td><label>
              <select name="qualification" id="qualification">
			   ...
			   <script>document.getElementById('qualification').value='<%=kiosk.getQualification()%>';</script>
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
			  ...
			  <script>document.getElementById('occupation').value='<%=kiosk.getOccupation()%>';</script>
            </label></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td class="style2"><label>
              <input name="address1" type="text" id="address1" onKeyUp="writeOn('address1');" value="<%= kiosk.getAddress1()%>" maxlength="300">
            </label></td>
            <td class="style6">Address</td>
            <td><label>
              <input name="address2" type="text" id="address2" value="<%= kiosk.getAddress2()%>" maxlength="300">
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <input name="city1" type="text" id="city1" onKeyUp="writeOn('city1');" value="<%= kiosk.getCity1()%>" maxlength="30">
            </label></td>
            <td class="style6">City</td>
            <td><label>
              <input name="city2" type="text" id="city2" value="<%= kiosk.getCity2()%>" maxlength="30">
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <input name="state1" type="text" id="state1" onKeyUp="writeOn('state1')" value="<%= kiosk.getState1()%>" maxlength="30">
            </label></td>
            <td class="style6">State</td>
            <td><label>
              <input name="state2" type="text" id="state2" value="<%= kiosk.getState2()%>" maxlength="30">
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <input name="country1" type="text" id="country1" onKeyUp="writeOn('country1')" value="<%= kiosk.getCountry1()%>" maxlength="30">
            </label></td>
            <td class="style6">Country</td>
            <td><label>
              <input name="country2" type="text" id="country2" value="<%= kiosk.getCountry2()%>" maxlength="30">
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
            <input name="zip1" type="text" id="zip1" onKeyUp="writeOn('zip1')" value="<%= kiosk.getZip1()%>" maxlength="6" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td class="style6">Zip</td>
            <td><label>
              <input name="zip2" type="text" id="zip2" value="<%= kiosk.getZip2()%>" maxlength="6" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <input name="landline1" type="text" id="landline1" onKeyUp="writeOn('landline1')" value="<%= kiosk.getLandline1()%>" maxlength="20" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td class="style6">Phone </td>
            <td><label>
              <input name="landline2" type="text" id="landline2" value="<%= kiosk.getLandline2()%>" maxlength="20" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style8"><label>
              <input name="mobile1" type="text" id="mobile1" onKeyUp="writeOn('mobile1')" value="<%= kiosk.getMobile1()%>" maxlength="15" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td class="style9">Mobile</td>
            <td class="style10"><label>
              <input name="mobile2" type="text" id="mobile2" value="<%= kiosk.getMobile2()%>" maxlength="15" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="style2"><label>
              <input name="email" type="text" id="email" value="<%= kiosk.getEmail()%>" maxlength="30">
            </label></td>
            <td class="style6">Alternate Email </td>
            <td><label>
              <input name="alternateEmail" type="text" id="alternateEmail" value="<%= kiosk.getAlternateEmail()%>" maxlength="30">
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <select name="bloodGroup" id="bloodGroup">
				...
				<script>document.getElementById('bloodGroup').value='<%=kiosk.getBloodGroup()%>';</script>
            </label></td>
            <td colspan="3">&nbsp;</td>
            </tr>
          <tr>
