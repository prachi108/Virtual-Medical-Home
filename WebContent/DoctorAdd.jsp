	...
	{  
	  ...
	  var idvalue=document.getElementById('id').value;
	   xmlHttp = GetXmlHttpObject();
		...
		var url="DoctorCheckAvailabilityHandler.jsp";
		url=url+"?id="+idvalue;
...
<tr height="475px">
    <td><center>
      <form name="form1" method="post" onSubmit="return validateForm();" action="DoctorHandler.jsp" >
        <table width="80%" id="innertable">
          ...
          <tr>
            <td colspan="5"><h3><strong><span class="style1" style="height: 21px">Fill All Information to add a doctor </span></strong></h3></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="style5">Specialization*</td>
            <td class="style2"><label>
			<select name="specialization" size="5"  multiple="multiple" id="specialization">
	  ...
	  %>
	   ...
	   <%}
          ...
          <tr>
            ...
            <td class="style2"><label>
              <input name="landline1" type="text" id="landline1" onKeyUp="writeOn('landline1')" maxlength="20" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
