...
<tr height="475px">
    <td><center>
      <form name="form1" method="post" onSubmit="return validateForm();" action="PatientEditHandler.jsp">
        <table width="80%">
          <tr>
          ...
          <tr>
            ...
            <td width="20%" class="style2"><label>
              <input name="name" type="text" id="name" value="<%= patient.getName()%>" maxlength="50">
            </label></td>
            <td width="17%" class="style6">Fathers Name* </td>
            <td width="26%"><label>
              <input name="fname" type="text" id="fname" value="<%= patient.getFname()%>" maxlength="50">
            </label></td>
            <td width="20%">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <input name="dob" type="text" id="dob" value="<%= patient.getDob()%>">
            </label></td>
          ...
          <tr>
            ...
            <td class="style2"><label>
              ...
              Other</label>
			  <script>
			  if('<%=patient.getNationality()%>'=='Indian'){
            ...
            <td><label>
              <select name="qualification" id="qualification">
			   ...
			   <script>document.getElementById('qualification').value='<%=patient.getQualification()%>';</script>
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
			  ...
			  <script>document.getElementById('occupation').value='<%=patient.getOccupation()%>';</script>
            </label></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td class="style2"><label>
              <input name="address1" type="text" id="address1" onKeyUp="writeOn('address1');" value="<%= patient.getAddress1()%>" maxlength="300">
            </label></td>
            <td class="style6">Address</td>
            <td><label>
              <input name="address2" type="text" id="address2" value="<%= patient.getAddress2()%>" maxlength="300">
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <input name="city1" type="text" id="city1" onKeyUp="writeOn('city1');" value="<%= patient.getCity1()%>" maxlength="30">
            </label></td>
            <td class="style6">City</td>
            <td><label>
              <input name="city2" type="text" id="city2" value="<%= patient.getCity2()%>" maxlength="30">
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <input name="state1" type="text" id="state1" onKeyUp="writeOn('state1')" value="<%= patient.getState1()%>" maxlength="30">
            </label></td>
            <td class="style6">State</td>
            <td><label>
              <input name="state2" type="text" id="state2" value="<%= patient.getState2()%>" maxlength="30">
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <input name="country1" type="text" id="country1" onKeyUp="writeOn('country1')" value="<%= patient.getCountry1()%>" maxlength="30">
            </label></td>
            <td class="style6">Country</td>
            <td><label>
              <input name="country2" type="text" id="country2" value="<%= patient.getCountry2()%>" maxlength="30">
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
            <input name="zip1" type="text" id="zip1" onKeyUp="writeOn('zip1')" value="<%= patient.getZip1()%>" maxlength="6" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td class="style6">Zip</td>
            <td><label>
              <input name="zip2" type="text" id="zip2" value="<%= patient.getZip2()%>" maxlength="6" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <input name="landline1" type="text" id="landline1" onKeyUp="writeOn('landline1')" value="<%= patient.getLandline1()%>" maxlength="20" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td class="style6">Phone </td>
            <td><label>
              <input name="landline2" type="text" id="landline2" value="<%= patient.getLandline2()%>" maxlength="20" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style8"><label>
              <input name="mobile1" type="text" id="mobile1" onKeyUp="writeOn('mobile1')" value="<%= patient.getMobile1()%>" maxlength="15" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td class="style9">Mobile</td>
            <td class="style10"><label>
              <input name="mobile2" type="text" id="mobile2" value="<%= patient.getMobile2()%>" maxlength="15" onKeyPress="allowIntegerValueNonNegative(event, this);" />
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="style2"><label>
              <input name="email" type="text" id="email" value="<%= patient.getEmail()%>" maxlength="30">
            </label></td>
            <td class="style6">Alternate Email </td>
            <td><label>
              <input name="alternateEmail" type="text" id="alternateEmail" value="<%= patient.getAlternateEmail()%>" maxlength="30">
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="style2"><label>
              <select name="bloodGroup" id="bloodGroup">
				...
				<script>document.getElementById('bloodGroup').value='<%=patient.getBloodGroup()%>';</script>
            </label></td>
            <td colspan="3">&nbsp;</td>
            </tr>
          <tr>
