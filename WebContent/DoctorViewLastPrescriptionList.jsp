...
<head>
<title>Last Prescriptions List</title>
...
<tr height="475px">
    <td><div style="overflow:auto; height:450px; "><table width="1200" align="center">
      <tr>
        <td colspan="6"><center>
          <h1><strong><span class="lblHeading">Last Prescriptions List</span></strong></h1>
        </center></td>
        </tr>
	  ...
	  ArrayList list = patientHistory.getDoctorHistoryList();
      ...
      <tr bgcolor=<%=i%2==0?"#FFFBF0":"#CCCCFF"%>>
        ...
        <td><a href="DoctorViewLastPrescription.jsp?transactionId=<%=transactionIdList.get(i)%>">View Prescription</a></td>
      </tr>
	  <%}
	  }else{
	  %>
