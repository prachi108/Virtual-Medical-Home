	...
	{  
	  ...
	  var idvalue=document.getElementById('id').value;
	   xmlHttp = GetXmlHttpObject();
		...
		var url="AdminCheckAvailabilityHandler.jsp";
		url=url+"?id="+idvalue;
...
<tr height="475px">
    <td><center>
      <form name="form1" method="post" onSubmit="return validateForm();" action="AdminHandler.jsp">
        <table width="80%" id="innertable">
          ...
          <tr>
            <td colspan="5"><h3><strong><span class="style1" style="height: 21px">Fill All Information to add a admin </span></strong></h3></td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="5" class="style5"><center><label>
              <input type="submit" class="style5" style="width:150px;" name="Submit" value="Save"">
            </label></center></td>
            </tr>
