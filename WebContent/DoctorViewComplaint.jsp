<%@ page contentType="text/html; charset=utf-8" language="java" errorPage="ErrorPage.jsp" import="java.sql.*,java.util.*" %>
...
<table width="100%" align="center" border="1">
  ...
  <tr>
    <td><jsp:include page="DoctorMenu.jsp"></jsp:include></td>
  </tr>
  
  <tr align="center"  height="450px">
    <td><div style="overflow:auto; height:450px; "><table width="95%" height="215">
      <tr>
        <th width="951" scope="col"><span class="lblHeading">View Complaints</span></th>
        </tr>
		<%
	...
	<tr align="left">
          <td style="color:#CC0000"><table width="100%" >
            <tr>
              <td width="24%">ComplaintId</td>
            ...
            <tr>
              <td colspan="4"><form id="form1" name="form1" method="post" action="DoctorViewComplaintHandler.jsp">
			  ...
			  <tr align="center">
		  <td colspan="4"><form id="form2" name="form2" method="post" action="DoctorViewComplaintFinalReplyHandler.jsp">
