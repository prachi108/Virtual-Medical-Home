...
<jsp:setProperty name="appointment" property="patientId"/>
    ...
    <td><div style="overflow:auto; height:450px; "><table width="1200" align="center">
      <tr>
        <td colspan="11"><center>
          <h1><strong><span class="lblHeading">Patient Appointment List </span></strong></h1>
        </center></td>
        </tr>
	  ...
	  ArrayList list = appointment.getPatientAppointmentList();
	  if(list!=null && list.size()>0){
	  	ArrayList doctorNameList=(ArrayList)list.get(0);
		ArrayList appointmentDateList =(ArrayList)list.get(1);
		ArrayList allotmentDateList =(ArrayList)list.get(2);
		ArrayList appointmentRequestedDateList =(ArrayList)list.get(3);
		ArrayList requestDateList =(ArrayList)list.get(4);
		ArrayList appointmentIdList =(ArrayList)list.get(5);
		ArrayList descriptionList =(ArrayList)list.get(6);
		ArrayList remarkList =(ArrayList)list.get(7);
		ArrayList appointmentStatusList =(ArrayList)list.get(8);
