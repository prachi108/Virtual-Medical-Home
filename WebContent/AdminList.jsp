...
<tr height="475px">
    <td><div style="overflow:auto; height:450px; "><table width="1200" align="center">
      <tr align="center">
        <td colspan="7"><center><h3><strong>Admin List</strong></h3></center></td>
        </tr>
	  ...
	  ArrayList list = admin.getAdminList();
      ...
      <tr bgcolor=<%=i%2==0?"#FFFBF0":"#CCCCFF"%> >
        ...
        <td style="width:300px;"><a href="AdminEdit.jsp?id=<%=userNameList.get(i)%>">Edit </a>| 
        <a href="AdminView.jsp?id=<%=userNameList.get(i)%>">View</a>|
		<a href="AdminDisable.jsp?id=<%=userNameList.get(i)%>&status=<%=statusList.get(i)%>"><%=statusList.get(i)%></a>|
		<a href="AdminResetPassword.jsp?id=<%=userNameList.get(i)%>">Reset Password</a>		
		</td>
      </tr>
	  <%}
	  }else{
